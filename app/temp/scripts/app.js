	      ...
	      this.itemsToReveal.each(function () {
	        ...
	        new Waypoint({
	          ...
	          handler: function handler() {
	            (0, _jquery2.default)(currentItem).addClass("hide-item--show");
	          },
	          offset: offset
	        });
	      });
	    ...
	    value: function createPageSectionWaypoints() {
	      ...
	      this.pageSections.each(function () {
	        ...
	        new Waypoint({
	          ...
	          handler: function handler(direction) {
	            if (direction == "down") {
	              var headerLink = (0, _jquery2.default)(currentPageSection).data("link");
	              that.headerLinks.removeClass("current-link");
	              (0, _jquery2.default)(headerLink).addClass("current-link");
	            }
	          },
	          offset: "18%"
	        });
